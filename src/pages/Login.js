...
import { useNavigate } from 'react-router-dom';  // utilisez useNavigate ici
...
const Login = () => {
  ...
  return (
    <div className='flex justify-center items-center h-screen bg-blue-200 px-4 sm:px-6 lg:px-8'>
